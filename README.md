...
A Dockerfile to build [netfilter/iptables project homepage - The netfilter.org "nftables" project](http://netfilter.org/projects/nftables/) rpm for CentOS 7 using [fedora copr](https://copr.fedoraproject.org/).
